      ...
      <div className="flex-1 flex flex-col px-8 py-6 max-w-7xl mx-auto w-full">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-zinc-500 text-lg max-w-2xl mx-auto leading-relaxed">
            Choose the perfect plan for your AI design needs. Scale as you grow
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-zinc-500 text-sm leading-relaxed">
                ...
                any time. Changes take effect at the next billing cycle.
              </p>
            </div>
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-zinc-500 text-sm leading-relaxed">
                Credits reset monthly based on your plan. Unused credits do not
                roll over, but you can purchase additional credits anytime.
              </p>
            </div>
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-zinc-500 text-sm leading-relaxed">
                Absolutely! Start with our Free Starter plan (50 credits/month)
