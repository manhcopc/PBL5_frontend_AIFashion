export const mockTrends = [
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1529139574466-a303027c1d8b?w=800&auto=format&fit=crop&q=60',
    percentage: '+65%'
  },
  {
    id: 't3',
    title: 'Cottage Core Dream',
...
export const styleTagsList = [
  'Oversized', 'Streetwear', 'Vintage', 'Futuristic', 
  'Floral', 'Monochrome', 'Asymmetrical', 'Techwear'
];

export const categoriesList = [
  'Dresses', 'Outerwear', 'Tops & Blouses', 'Trousers', 'Accessories'
];
